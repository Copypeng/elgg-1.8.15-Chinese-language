...
/**
 * Chinese Language 
 * @package Copypeng_Elgg_Language
 * @contact :
 * Author: Copypeng pengyongouc@gmail.com
 * L: Qingdao,China
 * GIT:https://github.com/Copypeng/elgg-1.8.15-Chinese-language
 */
$chinese = array(
/**
 * Sites
 ...
 */
	...
	'logout' => "登出",
	'logoutok' => "您已经登出.",
	'logouterror' => "抱歉，竟然登出失败，请再试一次.",

	'loggedinrequired' => "想查看该页面？您需要登陆哦.",
	'adminrequired' => "您需要成为管理员才能查看该页面.",
	'membershiprequired' => "您需要加入此小组才能查看该页面",
 ...
 */
	...
	'exception:contact_admin' => '不可恢复错误！系统已记录此错误，请联系网站管理员。以下是详细信息：',

	'actionundefined' => "您请求的操作(Action) (%s) 在系统中没有哦.",
	'actionnotfound' => "抱歉，%s 的操作(Action)文件没有找到.",
	'actionloggedout' => "抱歉，在您登出的时候不能进行此操作.",
	'actionunauthorized' => '额，您没有权限进行此操作.',

	'InstallationException:SiteNotInstalled' => '无法处理此请求，此站点 '
		. ' 还未配置完成或已经关闭。',
	'InstallationException:MissingLibrary' => '无法载入 %s',
	...
	'DatabaseException:NoConnect' => "系统无法连接数据库 '%s', 请检查数据库是否存在并有权限访问.",
	...
	'DatabaseException:InvalidDBLink' => "与数据库断开连接.",

	'IOException:FailedToLoadGUID' => "无法加载新的 %s 来自GUID:%d",
	...
	'PluginException:CannotStart' => '%s (guid: %s) 无法启动，已被释放。原因: %s',
	...
	'PluginException:NullInstantiated' => '系统插件不能是个空的实例。你必须传递一个GUID, 一个plugin ID, 或者它的完全路径.',

	'ElggPlugin:MissingID' => '丢失插件 ID (GUID %s)',
	'ElggPlugin:NoPluginPackagePackage' => '丢失插件ID %s 的 ElggPluginPackage(guid %s)',

	'ElggPluginPackage:InvalidPlugin:MissingFile' => '丢失必要文件"%s".',
	...
	'ElggPlugin:Exception:CannotIncludeFile' => '无法包含 %s 进入插件 %s (guid: %s) 位于 %s.',
	'ElggPlugin:Exception:CannotRegisterViews' => '无法为插件 %s 打开视图目录(guid: %s) 位于 %s.',
	'ElggPlugin:Exception:CannotRegisterLanguages' => '无法为插件 %s 注册语言文件(guid: %s) 位于 %s.',
	...
	'ElggPlugin:Dependencies:Requires' => '必需',
	...
	'ElggPlugin:Dependencies:PhpExtension' => 'PHP 插件: %s',
	...
	'IOException:MissingFileName' => "打开文件之前须制定文件名.",
	...
	'NotificationException:ErrorNotifyingGuid' => "发布通知时遇到错误 %d",
	...
	'InvalidParameterException:NoEntityFound' => "没有找到实体，可能实体不存在，或者您没有访问权限.",

	'InvalidParameterException:GUIDNotFound' => "GUID:%s 没有被找到或者您没有访问权限.",
	'InvalidParameterException:IdNotExistForGUID' => "抱歉, '%s' 不存在 guid:%d",
	'InvalidParameterException:CanNotExportType' => "抱歉, 系统不知如何导出 '%s'",
	...
	'InvalidParameterException:MissingParameter' => "丢失参数，您需要指定 GUID.",
	'InvalidParameterException:LibraryNotRegistered' => '%s 不是一个注册过的类库',
	'InvalidParameterException:LibraryNotFound' => '无法载入 %s 类库 来自 %s',
	...
	'SecurityException:ForwardFailedToRedirect' => '未预料的权限控制 gatekeeper 调用请求。由于安全原因中断执行。搜索 http://docs.elgg.org/ 查看原因.',
	...
	'SecurityException:AuthTokenExpired' => "验证 token 丢失，无效或者超时.",
	...
	'SecurityException:InvalidAPIKey' => "无效或者丢失API Key.",
	...
	'PluginException:NoPluginName' => "这个插件名没有找到",

	'SecurityException:authenticationfailed' => "用户没有被验证",

	'CronException:unknownperiod' => '%s 不是一个可以被识别的周期.',

	'SecurityException:deletedisablecurrentsite' => '您可以删除或者关闭正在访问的站点!',

	'RegistrationException:EmptyPassword' => '密码不能为空哦.',
	'RegistrationException:PasswordMismatch' => '密码必须匹配',
	'LoginException:BannedUser' => '您已经被此站点屏蔽，不能登陆.',
	'LoginException:UsernameFailure' => '登陆失败，请检查您的用户名/email和密码.',
	'LoginException:PasswordFailure' => '登陆失败，请检查您的用户名/email和密码.',
	'LoginException:AccountLocked' => '您的账户已经被锁定，因为日志中发现了大量的错误数据.',
	'LoginException:ChangePasswordFailure' => '当前密码校验失败.',
	'LoginException:Unknown' => '登陆失败，原因未知.',
	...
	'noaccess' => '您需要登陆以查看此内容或者此内容已经被删除，还有可能您没有访问权限.',
	'error:missing_data' => '您的请求中缺失一些数据',

	'error:default' => '糟糕，出错了.',
	'error:404' => '抱歉，我们没有找到此页面.',
 ...
 */
	...
	'email' => "邮箱地址",
	'username' => "用户名",
	'loginusername' => "用户名或邮箱地址",
	'password' => "密码",
	'passwordagain' => "密码验证（请重新输入一次）",
	'admin_option' => "是否设置为管理员？",
 ...
 */
	...
	'widgets:save:success' => "控件已成功保存.",
	'widgets:save:failure' => "保存控件失败.",
 ...
 */
	...
	'friends:add:successful' => "您成功的添加 %s 为好友.",
	'friends:add:failure' => "抱歉，无法添加 %s 为好友.",

	'friends:remove:successful' => "您已经成功的从好友中移除了 %s.",
	'friends:remove:failure' => "移除好友 %s 失败.",
	...
	'friends:nocollections' => "您还未加入任何好友圈.",
	...
	'avatar:remove:success' => '移除头像成功',
	'avatar:remove:fail' => '移除头像失败',
	...
	'profile:resetdefault:confirm' => '您确定要删除您的自定义资料字段？',
	...
	'profile:editdefault:success' => '资料字段添加成功',
	'profile:editdefault:fail' => '无法保存默认个人资料',
	'profile:field_too_long' => '抱歉，无法保存您的个人资料，原因："%s" 部分过长.',
	'profile:noaccess' => "您没有权限编辑此用户资料.",
 ...
 */
	...
	'river:update:user:profile' => '%s 更新了个人资料',
	...
	'river:none' => '没有活动',
	'river:update' => '更新%s',
	'river:delete:success' => '活动已经被删除',
	'river:delete:fail' => '活动删除失败',

	'river:widget:title' => "动态",
	'river:widget:description' => "最新动态",
	'river:widget:type' => "动态类型",
	'river:widgets:friends' => '好友动态',
	'river:widgets:all' => '整站动态',

/**
 * Notifications
 */
	'notifications:usersettings' => "通知设置",
	'notifications:methods' => "请输入您选择的通知方式.",
	'notification:method:email' => 'Email',

	'notifications:usersettings:save:ok' => "您的通知设置已成功保存.",
	'notifications:usersettings:save:fail' => "保存您的通知设置时出错.",
 ...
 */
	...
	'registerbad' => "您未成功注册，错误原因未知.",
	'registerdisabled' => "系统管理员已关闭开放注册",
	'register:fields' => '所有字段都是必须的',

	'registration:notemail' => '您输入的邮箱地址无效.',
	'registration:userexists' => '用户名已存在',
	'registration:usernametooshort' => '您的用户名最少需要 %u 位字符.',
	'registration:usernametoolong' => '用户名过长，最大不超过 %u 位字符.',
	'registration:passwordtooshort' => '您的密码最少需要 %u 位字符.',
	'registration:dupeemail' => '这个Email地址已经被注册过了.',
	'registration:invalidchars' => '抱歉，您的用户名包含了以下无效的字符: %s。所有这些字符都是无效的： %s',
	'registration:emailnotvalid' => '抱歉，您输入的邮件地址无效',
	'registration:passwordnotvalid' => '抱歉，您输入的密码无效',
	'registration:usernamenotvalid' => '抱歉，您输入的用户名无效',
	...
	'user:resetpassword:unknown_user' => '无此用户.',
	'user:resetpassword:reset_password_confirm' => '重置密码会将新的密码发送到您注册邮箱中.',
 ...
 */
	...
	'admin:configuration:dataroot:relative_path' => '无法将 "%s" 设置为dataroot，原因：不是绝对路径.',
	...
	'admin:appearance' => '界面',
	'admin:administer_utilities' => '插件',
	'admin:develop_utilities' => '插件',

	'admin:users' => "用户",
	'admin:users:online' => '当前在线',
	'admin:users:newest' => '新用户',
...
"管理后台的导航在右边的菜单。主要功能分为三部分：
	...
	'admin:widget:control_panel:help' => "提供轻松访问通用控件",

	'admin:cache:flush' => '刷新缓存',
	'admin:cache:flushed' => "此站点缓存已被刷新",

	'admin:footer:faq' => '管理员 FAQ',
	'admin:footer:manual' => '管理员手册',
	'admin:footer:community_forums' => 'Elgg社区',
	'admin:footer:blog' => 'Elgg博客',

	'admin:plugins:category:all' => '所有插件',
	'admin:plugins:category:active' => '已激活插件',
	'admin:plugins:category:inactive' => '未激活插件',
	'admin:plugins:category:admin' => '管理员',
	'admin:plugins:category:bundled' => '已捆绑',
	'admin:plugins:category:nonbundled' => '未捆绑',
	...
	'admin:plugins:category:utility' => '实用程序',

	'admin:plugins:sort:priority' => '优先级顺序',
	'admin:plugins:sort:alpha' => '字母顺序',
	'admin:plugins:sort:date' => '时间顺序',
	...
	'item:object:admin_notice' => '管理员提示',
 ...
 * Plugins
 */
	'plugins:disabled' => '插件加载失败，原因：mod directory中有名为"disabled"的文件.',
	...
	'admin:plugins:label:bugtracker' => "提交BUG",
	...
	'admin:plugins:warning:invalid' => '%s 不是一个有效的插件',
	'admin:plugins:warning:invalid:check_docs' => '点击<a href="http://docs.elgg.org/Invalid_Plugin">系统文档</a> 排除问题.',
	'admin:plugins:cannot_activate' => '无法激活',

	'admin:plugins:set_priority:yes' => "排序 %s 成功.",
	'admin:plugins:set_priority:no' => "排序 %s 失败.",
	'admin:plugins:set_priority:no_with_msg' => "排序 %s 失败. 错误: %s",
	'admin:plugins:deactivate:yes' => "禁用 %s 成功.",
	'admin:plugins:deactivate:no' => "禁用 %s 失败.",
	'admin:plugins:deactivate:no_with_msg' => "禁用 %s 失败. 错误: %s",
	'admin:plugins:activate:yes' => "激活 %s 成功.",
	'admin:plugins:activate:no' => "激活 %s 失败.",
	'admin:plugins:activate:no_with_msg' => "激活 %s 失败. 错误: %s",
	'admin:plugins:categories:all' => '所有分类',
	'admin:plugins:plugin_website' => '插件站点',
	'admin:plugins:author' => '%s',
	'admin:plugins:version' => '版本 %s',
	'admin:plugin_settings' => '插件设置',
	'admin:plugins:warning:unmet_dependencies_active' => '此插件已激活，但是没有满足依赖关系。您可能会遇到错误。点击下方的 "更多信息" 查看详细情况.',
	...
	'admin:server:label:mem_used' => '已用内容',
	'admin:server:error_log' => "Web服务器错误日志",
	'admin:server:label:post_max_size' => 'POST 最大文件大小',
	'admin:server:label:upload_max_filesize' => '上传最大文件大小',
	'admin:server:warning:post_max_too_small' => '(提示: post_max_size须大于此值.)',
	...
	'admin:user:removeadmin:yes' => "成功取消用户管理员权限.",
	'admin:user:removeadmin:no' => "取消用户管理员权限失败.",
	...
	'admin:default_widgets:unknown_type' => '未知控件类型',
	'admin:default_widgets:instructions' => '添加, 移除, 放置和配置默认控件到设定的控件页面中.'
		. ' 这些修改将会仅对新用户有效.',
 ...
 */
	...
	'usersettings:statistics:label:lastlogin' => "最近登陆",
 ...
 */
	...
	'content' => "内容",
	'content:latest' => '最新活动',
	'content:latest:blurb' => '或者点击这里来查看最新的全站内容.',
 ...
 */
	...
	'deleteconfirm' => "确认删除本条目吗?",
	'deleteconfirm:plural' => "确定删除这些条目吗?",
	'fileexists' => "文件已经上传过了，如果需要替换它请从下方：",
 ...
 */
	...
	'installation:disableapi' => "elgg API 是一个弹性和高拓展性的接口,确保了其他外部系统可以访问Elgg.",
	'installation:disableapi:label' => "开启elgg网络服务API",
	...
	'installation:systemcache:label' => "使用简单缓存机制(推荐)",

	'upgrading' => '升级中...',
	'upgrade:db' => '数据库结构已经升级完成.',
	'upgrade:core' => '您的elgg安装已经完成.',
	'upgrade:unlock' => '开启升级',
	'upgrade:unlock:confirm' => "另一个升级进行中，数据库已经被锁定.同时升级还挺危险的.你确定你要进行这个升级么?",
	'upgrade:locked' => "无法升级，因为另一个升级正在进行.请转到管理员面板，解除升级锁定.",
	'upgrade:unlock:success' => "成功解锁升级.",
	'upgrade:unable_to_upgrade' => '升级失败.',
 ...
 */
	...
	'river:comment:object:default' => '%s 评论了 %s',
	...
	'generic_comment:title' => '来自%s的评论',
	'generic_comment:on' => '%s 对 %s的评论',
 ...
 */
	...
	'actiongatekeeper:uploadexceeded' => '您上传的文件大小超过了规定的最大大小',
	'actiongatekeeper:crosssitelogin' => "抱歉，系统禁止从其他主机登录，请重新尝试.",
